...
d=a.querySelector(".playlistTrackCount")||a.querySelector(".compactTrackList__moreLink"),e=a.querySelector(".soundTitle__tagContent"),k=a.querySelector(".soundTitle__username, .chartTrack__username a, .playableTile__usernameHeading, .trackItem__username"),f=a.querySelector(".soundTitle__title, .chartTrack__title a, .playableTile__artworkLink, .trackItem__trackTitle"),h=document.querySelector("#sce-moreActions-group"),g=document.createElement("div");g.className="moreActions__group";g.id="sce-moreActions-group";
var p=function(){window.location.href=f.href+"/recommended"},l=function(a,b){b=void 0===b?null:b;if(!document.querySelector("#sce-"+a+"-button")){var c=document.createElement("button");c.type="button";c.id="sce-"+a+"-button";c.className="moreActions__button sc-button-medium sce-button-icon sce-button-"+a+"";"related"===a?(c.title="Go to related tracks",c.innerText="Related tracks"):"track"===a?isPlaylistURL(b.href)?(c.title="Click to blacklist this playlist",c.innerText="Blacklist playlist"):(c.title=
"Click to blacklist this track",c.innerText="Blacklist track"):(c.title="Click to blacklist this track's "+a+"",c.innerText="Blacklist "+a+"");"related"!==a&&c.setAttribute("data-item","artist"===a||"track"===a?b.href:b.innerText);"artist"===a?stripLinkDomain(k.href)!=_userName&&g.appendChild(c):g.appendChild(c)}},r=!1,t=!1,x=!1,q=!1;c.moreActionMenu&&("on"===c.moreActionMenu.relatedActionMenu&&(r=!0),"on"===c.moreActionMenu.tagActionMenu&&(t=!0),"on"===c.moreActionMenu.artistActionMenu&&(x=!0),"on"===
c.moreActionMenu.trackActionMenu&&(q=!0));r||d||l("related");!t&&e&&l("hashtag",e);!x&&k&&l("artist",k);!q&&f&&l("track",f);h||g.hasChildNodes()&&b.appendChild(g);c=document.querySelector("#sce-related-button");b=document.querySelector("#sce-hashtag-button");d=document.querySelector("#sce-artist-button");e=document.querySelector("#sce-track-button");!r&&c&&(c.removeEventListener("click",p),c.addEventListener("click",p));!t&&b&&addTagToFilter(b);!x&&d&&addItemToFilter(d,"artists");!q&&e&&addItemToFilter(e,
...
c=document.querySelector("#listenerMode"),b=document.querySelector("#fullwidthMode"),d=document.querySelector("#profileImages"),e=document.querySelector("#hideSidebar"),k=document.querySelector("#hideBranding"),f=document.querySelector("#hideHeaderMenu"),h=document.querySelector("#hideFooterMenu"),g=document.querySelectorAll('input[name="displayType"]'),p=document.querySelector("#removePreviews"),l=document.querySelector("#removePlaylists"),r=document.querySelector("#removeLongTracks"),t=document.querySelector("#removeUserActivity"),
x=document.querySelector("#removeReposts"),q=document.querySelector("#relatedActionMenu"),v=document.querySelector("#tagActionMenu"),w=document.querySelector("#artistActionMenu"),z=document.querySelector("#trackActionMenu"),u=document.querySelector("#hiddenOutline"),A=document.querySelector("#disableUnfollower"),D=document.querySelector("#disableDiscoverToggle"),B=document.querySelector("#sce-settings-reset"),y=document.querySelectorAll(".sce-close-settings"),E=y.length,H=[a,c,b,d,e,k,f,h,g[0],g[1],
g[2],p,l,r,t,x,q,v,w,z,u,A,D],G=0;G<E;G++)y[G].addEventListener("click",function(){return disassembleSettings()});document.addEventListener("mousedown",function(a){var c=null===a?event:a;1!==c.which&&0!==c.button&&1!==c.button||"sce-settings"!==a.target.id||disassembleSettings()});B.addEventListener("click",function(){"true"===B.getAttribute("warning")?resetLocalStorage(function(){return location.reload()}):(B.setAttribute("warning",!0),B.innerText="Are you sure you want to reset?",setTimeout(function(){B.setAttribute("warning",
!1);B.innerText="Reset all SCEnhancer settings"},5E3))});getLocalStorage(function(m){"on"===m.darkMode&&(a.checked=!0);"on"===m.listenerMode&&(c.checked=!0);"on"===m.fullwidthMode&&(b.checked=!0);"on"===m.profileImages&&(d.checked=!0);"on"===m.hideSidebar&&(e.checked=!0);"on"===m.hideBranding&&(k.checked=!0);m.settingsMenus?("on"===m.settingsMenus.hideHeaderMenu&&(f.checked=!0),"on"===m.settingsMenus.hideFooterMenu&&(h.checked=!0)):setLocalStorage(function(){_debugMode&&console.log("-> Setting updated: settingsMenus (Default)")},
{settingsMenus:_defaultMenus});"list"===m.displayType?g[1].checked=!0:"grid"===m.displayType?g[2].checked=!0:g[0].checked=!0;"on"===m.removePreviews&&(p.checked=!0);"on"===m.removePlaylists&&(l.checked=!0);"on"===m.removeLongTracks&&(r.checked=!0);"on"===m.removeUserActivity&&(t.checked=!0);"on"===m.removeReposts&&(x.checked=!0);m.moreActionMenu&&("on"===m.moreActionMenu.relatedActionMenu&&(q.checked=!0),"on"===m.moreActionMenu.tagActionMenu&&(v.checked=!0),"on"===m.moreActionMenu.artistActionMenu&&
...
frontEndStreamManipulation(!0)},n=function(a,c,b,d){b=void 0===b?null:b;d=void 0===d?null:d;getLocalStorage(function(C){var e={},f=c.split("."),g="on",h=C[c];c.match(/[.]/)&&(h=C[f[0]][f[1]]);"on"===h&&(g="off");c.match(/[.]/)?(e[f[0]]=C[f[0]],"settingsMenus"===f[0]?"hideHeaderMenu"===f[1]?e[f[0]].hideHeaderMenu=g:"hideFooterMenu"===f[1]&&(e[f[0]].hideFooterMenu=g):"moreActionMenu"===f[0]&&("relatedActionMenu"===f[1]?e[f[0]].relatedActionMenu=g:"tagActionMenu"===f[1]?e[f[0]].tagActionMenu=g:"artistActionMenu"===
f[1]?e[f[0]].artistActionMenu=g:"trackActionMenu"===f[1]&&(e[f[0]].trackActionMenu=g))):e[c]="displayType"===c?a.value:g;setLocalStorage(function(){_debugMode&&console.log(e);if("displayType"===c)_body.setAttribute("displaytype",a.value);else if("hideHeaderMenu"===f[1]||"hideFooterMenu"===f[1])"on"===g?b(!0):b();else if(d)b(g,d);else{var C=c.toLowerCase();"on"===g?_body.setAttribute(C,""):_body.removeAttribute(C)}},e)})};H.forEach(function(m){m.addEventListener("change",function(){match(m).on(function(c){return c===
a},function(a){return n(a,"darkMode")}).on(function(a){return a===c},function(a){return n(a,"listenerMode")}).on(function(a){return a===b},function(a){return n(a,"fullwidthMode")}).on(function(a){return a===d},function(a){return n(a,"profileImages")}).on(function(a){return a===e},function(a){return n(a,"hideSidebar")}).on(function(a){return a===k},function(a){return n(a,"hideBranding")}).on(function(a){return a===f},function(a){return n(a,"settingsMenus.hideHeaderMenu",manageHeaderEnhancerButton)}).on(function(a){return a===
h},function(a){return n(a,"settingsMenus.hideFooterMenu",manageFooterEnhancerButton)}).on(function(a){return a===g[0]},function(a){return n(a,"displayType")}).on(function(a){return a===g[1]},function(a){return n(a,"displayType")}).on(function(a){return a===g[2]},function(a){return n(a,"displayType")}).on(function(a){return a===p},function(a){return n(a,"removePreviews",F,"preview")}).on(function(a){return a===l},function(a){return n(a,"removePlaylists",F,"preview")}).on(function(a){return a===r},
function(a){return n(a,"removeLongTracks",F,"long")}).on(function(a){return a===t},function(a){return n(a,"removeUserActivity",F,"yours")}).on(function(a){return a===x},function(a){return n(a,"removeReposts",F,"repost")}).on(function(a){return a===q},function(a){return n(a,"moreActionMenu.relatedActionMenu")}).on(function(a){return a===v},function(a){return n(a,"moreActionMenu.tagActionMenu")}).on(function(a){return a===w},function(a){return n(a,"moreActionMenu.artistActionMenu")}).on(function(a){return a===
z},function(a){return n(a,"moreActionMenu.trackActionMenu")}).on(function(a){return a===u},function(a){return n(a,"hiddenOutline")}).on(function(a){return a===A},function(a){return n(a,"disableUnfollower")}).on(function(a){return a===D},function(a){return n(a,"disableDiscoverToggle")})})})},filterInit=function(){_debugMode&&console.log("callback filterInit: Initializing");var a=document.querySelector("#artist-blacklist"),c=document.querySelector("#track-blacklist"),b=document.querySelector("#playlist-blacklist"),
...
function(a){a=a.split("/");var c=a[0];"sets"==a[1]?c=a[2]:a[1]&&(c=a[1]);c=c.replace(/-/g," ");return c=c.replace(/_/g," ")},k=function(a,c){getLocalStorage(function(b){var d=[],f=0,g=function(a){for(var c=[],b=0;b<f;b++)!0===a&&isPlaylistURL(d[b].slug)&&c.push(d[b]),!1===a&&(isPlaylistURL(d[b].slug)||c.push(d[b]));d=c},k=function(a,c,b){for(var d=a.length;d--;)a[d]&&a[d].hasOwnProperty(c)&&a[d][c]===b&&a.splice(d,1);return a};b.filter&&(d=b.filter.tracks,f=d.length,"artists"==c&&b.filter.artists?
(d=b.filter.artists,f=d.length):"tracks"==c&&b.filter.tracks?g(!1):g(!0));if(0===f)b=document.createElement("span"),b.innerHTML="No "+c+" has been filtered!",a.appendChild(b);else for(b={i:0};b.i<f;b={i:b.i,_listItemDelete:b._listItemDelete},b.i++){var g=document.createElement("li"),h=document.createElement("span"),q=document.createElement("a"),v=document.createElement("div"),w=document.createElement("span");b._listItemDelete=document.createElement("span");var z=b.i+1;h.className="sce-filter-item-order";
h.innerText="#"+z;v.className="sce-filter-actions";q.className="sce-filter-item-name";q.href="https://soundcloud.com/"+d[b.i].slug;q.innerText=e(d[b.i].slug);q.target="_blank";w.innerText=relativeTime(d[b.i].time);w.className="sce-filter-option";b._listItemDelete.className="sce-filter-option-remove";g.appendChild(h);g.appendChild(q);v.appendChild(w);v.appendChild(b._listItemDelete);g.appendChild(v);a.appendChild(g);b._listItemDelete.addEventListener("click",function(a){return function(){getLocalStorage(function(b){b=
b.filter;"artists"===c?k(b.artists,"slug",d[a.i].slug):k(b.tracks,"slug",d[a.i].slug);setLocalStorage(function(){a._listItemDelete.closest("li").remove();for(var b=document.querySelectorAll(".filter-container"),d=b.length,e=0;e<d;e++)if(!b[a.i].hasChildNodes()){var f=document.createElement("span");f.innerHTML="No "+c+" has been filtered!";b[e].appendChild(f)}},{filter:b})},["filter"])}}(b))}})};k(a,"artists");k(c,"tracks");k(b,"playlists")},getLocalStorage=function(a,c){chrome.storage.sync.get((void 0===
c?null:c)||_getGlobalSettings,a)},setLocalStorage=function(a,c){chrome.storage.sync.set((void 0===c?null:c)||_setGlobalSettings,a)},resetLocalStorage=function(a){chrome.storage.sync.remove(_getGlobalSettings,a)},readyStateCheck=function(){setAttributes();settingsSetup();injectedJavascript()};document.addEventListener("readystatechange",readyStateCheck);
...
d.className="announcements g-z-index-fixed-top m-offset";k.id="sce-logo";c||(_debugMode&&console.log("-> Branding rendered"),c=document.createElement("span"),c.id="version-display",c.innerText=_manifestData.version,k.appendChild(c));getLocalStorage(function(b){"on"!==b.settingsMenus.hideFooterMenu&&manageFooterEnhancerButton();"on"!==b.settingsMenus.hideHeaderMenu&&e.addEventListener("click",manageHeaderEnhancerButton);var c=setInterval(function(){var a=document.querySelector("ul.profileTabs.g-tabs");
if(a&&!document.querySelector("#profile-tab-like")){_debugMode&&console.log("-> Like shortcut rendered");clearInterval(c);var b=a.querySelector(".g-tabs-link:first-child").getAttribute("href"),d=document.createElement("li"),e=document.createElement("a");d.className="g-tabs-item";d.id="profile-tab-like";e.className="g-tabs-link";e.href=b+"/likes";e.innerText="Likes";d.appendChild(e);a.appendChild(d)}},100);if("on"!=b.disableDiscoverToggle&&"https://soundcloud.com/discover"==location.href)var d=setInterval(function(){var a=
document.querySelector("div.modularHome.lazyLoadingList ul.lazyLoadingList__list");if(a){clearInterval(d);var b=function(){getLocalStorage(function(b){_debugMode&&console.log("function discoverModuleHider: Running");for(var c=a.querySelectorAll(".selectionModule"),d=c.length,e={i:0};e.i<d;e={_moduleSwitch:e._moduleSwitch,i:e.i},e.i++){var f=b.discoverModules||{},g=1==f[e.i]?"hidden":"shown",k=c[e.i].querySelector("h2.selectionModule__titleText"),h=k.querySelector("a.hide-discover-section");c[e.i].setAttribute("state",
g);h||(g=1==f[e.i]?0:1,f=1==f[e.i]?"Show this section":"Hide this section",h=document.createElement("a"),h.className="hide-discover-section",h.innerText=f,h.setAttribute("section-id",e.i),h.setAttribute("section-state",g),k.appendChild(h),e._moduleSwitch=document.querySelector('.hide-discover-section[section-id="'+e.i+'"]'),e._moduleSwitch.addEventListener("click",function(a){return function(){getLocalStorage(function(b){var c=a._moduleSwitch.getAttribute("section-id"),d=a._moduleSwitch.getAttribute("section-state"),
e=b.discoverModules||{};e[c]=d;setLocalStorage(function(){if(chrome.runtime.lastError)alert("Error while saving settings:\n\n"+chrome.runtime.lastError);else{var b=1==e[c]?"Show this section":"Hide this section",d=1==e[a.i]?"hidden":"shown",f=1==e[c]?0:1,g=a._moduleSwitch.closest(".selectionModule");a._moduleSwitch.innerText=b;a._moduleSwitch.setAttribute("section-state",f);g.setAttribute("state",d)}},{discoverModules:e})})}}(e)))}})};b();runObserver(a,b)}},100);if("https://soundcloud.com/stream"==
location.href)var f=setInterval(function(){var c=document.querySelector(".stream__header");if(c&&(clearInterval(f),!a)){var d=document.createElement("div"),e=document.createElement("div"),g=document.createElement("h3"),k=document.createElement("ul"),h=document.createElement("li"),l=document.createElement("li"),u=document.createElement("li");d.className="stream__controls";d.id="stream-controller";e.className="listDisplayToggle g-flex-row-centered";g.className="listDisplayToggleTitle sc-text-light sc-type-medium";
g.innerText="View";k.className="listDisplayToggle sc-list-nostyle g-flex-row-centered";h.className="listDisplayToggle setting-display-tile default-icon";h.title="Default";h.setAttribute("data-id","default");l.className="listDisplayToggle setting-display-tile list-icon";l.title="Compact";l.setAttribute("data-id","list");u.className="listDisplayToggle setting-display-tile grid-icon";u.title="Grid";u.setAttribute("data-id","grid");e.appendChild(g);k.appendChild(h);k.appendChild(l);k.appendChild(u);e.appendChild(k);
d.appendChild(e);c.appendChild(d);var p=document.querySelector(".listDisplayToggle.setting-display-tile.default-icon"),D=document.querySelector(".listDisplayToggle.setting-display-tile.list-icon"),B=document.querySelector(".listDisplayToggle.setting-display-tile.grid-icon");"list"===b.displayType?D.classList.add("active"):"grid"===b.displayType?B.classList.add("active"):p.classList.add("active");for(var y=document.querySelectorAll(".listDisplayToggle.setting-display-tile"),E=y.length,c={i:0};c.i<
E;c={i:c.i},c.i++)y[c.i].addEventListener("click",function(a){return function(){for(var b=y[a.i].getAttribute("data-id"),c=0;c<E;c++)y[c].classList.remove("active");"list"===b?(_body.setAttribute("displaytype","list"),D.classList.add("active")):"grid"===b?(_body.setAttribute("displaytype","grid"),B.classList.add("active")):(_body.setAttribute("displaytype","default"),p.classList.add("active"));setLocalStorage(function(){chrome.runtime.lastError&&alert("Error while saving settings:\n\n"+chrome.runtime.lastError);
_debugMode&&console.log("-> Display mode saved: "+b)},{displayType:b})}}(c))}},100);if("https://soundcloud.com/you/following"==location.href&&"on"!==b.disableUnfollower)var k=setInterval(function(){var a=document.querySelector(".collectionSection__list .lazyLoadingList.badgeList ul.lazyLoadingList__list");if(a){clearInterval(k);var b=document.querySelector(".collectionSection__top");if(null==document.querySelector("#mass-unfollow")){var c=document.createElement("div"),d=document.createElement("div"),
...
n=document.createElement("hr"),m=document.createElement("span"),C=document.createElement("a");a.id="sce-settings";a.className="modal g-z-index-modal-background g-opacity-transition g-z-index-overlay modalWhiteout showBackground invisible";a.style.paddingRight="0px";a.style.outline="none";a.style.overflow="hidden";a.tabindex="-1";c.className="modal__closeButton sce-close-settings";c.title="Close";c.type="button";c.innerText="Close";b.className="modal__modal sc-border-box g-z-index-modal-content";d.className=
"modal__content";e.id="sce-settings-title";e.className="g-modal-title-h1 sc-truncate";e.innerText="SoundCloud Enhancer "+_manifestData.version;k.className="credits";k.innerHTML="Made with <span class='heart'>&hearts;</span> in Denmark by <a href='https://twitter.com/DapperBenji' target='_blank'>@DapperBenji</a>.";f.id="tab-container";f.className="g-tabs g-tabs-small";h.className="g-tabs-item";g.className="g-tabs-item";p.className="g-tabs-item";l.className="g-tabs-item";r.className="g-side-items";
t.className="g-tabs-item";t.id="sce-import";q.className="hidden";q.type="file";q.accept=".json";v.className="g-tabs-item";v.id="sce-export";w.setAttribute("action","settings");w.className="tab g-tabs-link active";w.innerText="Settings";z.setAttribute("action","filter");z.className="tab g-tabs-link";z.innerText="Filter (beta)";u.setAttribute("action","changelog");u.className="tab g-tabs-link";u.innerText="Changelog";A.setAttribute("action","about");A.className="tab g-tabs-link";A.innerText="About";
D.className="g-tabs-link";D.innerText="Import";B.className="g-tabs-link";B.innerText="Export";y.id="sce-settings-content";E.className="tabPage";E.id="settings";E.style.display="block";H.className="tabPage";H.id="filter";G.className="tabPage";G.id="changelog";F.className="tabPage";F.id="about";m.className="donation";C.href="https://www.paypal.me/BenjaminBachJensen";C.innerText="Support the development - Buy me a cup of coffee ;)";C.target="_blank";y.appendChild(E);y.appendChild(H);y.appendChild(G);
y.appendChild(F);h.appendChild(w);g.appendChild(z);p.appendChild(u);l.appendChild(A);x.appendChild(D);x.appendChild(q);t.appendChild(x);v.appendChild(B);r.appendChild(t);r.appendChild(v);f.appendChild(h);f.appendChild(g);f.appendChild(p);f.appendChild(l);f.appendChild(r);m.appendChild(C);d.appendChild(e);d.appendChild(k);d.appendChild(f);d.appendChild(y);d.appendChild(n);d.appendChild(m);b.appendChild(d);a.appendChild(c);a.appendChild(b);_body.appendChild(a);setTimeout(function(){a.classList.remove("invisible")},
